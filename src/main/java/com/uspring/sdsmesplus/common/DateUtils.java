...
public class DateUtils {
     ...
     * @return yyyy-MM-dd HH:mm:ss  格式
     */
    public static Date getBeginDayOfNextWeek(Date date) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        cal.add(Calendar.DAY_OF_YEAR, 7);
        return getBeginDayOfWeek(cal.getTime());
    }
    ...
    public static Date getEndDayOfNextWeek(Date date) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        return getEndDayOfWeek(cal.getTime());
    }
     ...
     */
      ...
      */
       ...
       * @return yyyy-MM-dd HH:mm:ss  格式
       */
       public static Date getEndyDayOfQuarter() {
              Calendar calendar = Calendar.getInstance();
              int month = getNowMonth();
              if(month <= 3){
             	 month = 3;
