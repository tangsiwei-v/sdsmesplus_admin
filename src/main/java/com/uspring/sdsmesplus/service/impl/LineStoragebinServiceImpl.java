...
public class LineStoragebinServiceImpl implements LineStoragebinService{
	...
	//查找产线库位主数据
	public PageInfo<LineStoragebinVO> selectLineStoragebins(Integer lineId, Integer page_size, Integer page_num, Integer shopId, Integer fcId) {
		if (page_num == null) {
			page_num = 1;
		}
		if (page_size == null) {
		...
		List<LineStoragebinVO> lineStoragebins = lineStoragebinDao.selectLineStoragebins(lineId, page_size, page_num, shopId, fcId);
